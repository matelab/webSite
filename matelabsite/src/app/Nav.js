        ...
        return (
            <div>
                ...
                <a href="#!" class="brand-logo">
                    <img src={logo} className="" alt="Mate Lab" width="40" height="37"/>
                </a>
                ...
                <ul class="right hide-on-med-and-down">
                    <li><Link to="" title="Servicios">Servicios</Link></li>
                    <li><Link to="" title="Productos">Productos</Link></li>
                    <li><Link to="" title="Investigación y desarrollo">I+D</Link></li>
                    <li><Link to="" title="Blog">Blog</Link></li>
                    <li><Link to="" title="Organización">Organización</Link></li>
                    <li><Link to="" title="Nosotros">Nosotros</Link></li>
